...
public class SeekBarPressure extends View {
    ...
    private static int mTextViewMarginTop = 30;   //当前滑块文字距离view顶部距离
    ...
    public SeekBarPressure(Context context, AttributeSet attrs, int defStyle) {
        ...
        notScrollBarBg = getResources().getDrawable(R.drawable.shape_seekbarpressure_bg_progress);
        hasScrollBarBg = getResources().getDrawable(R.drawable.shape_seekbarpressure_bg_normal);
        mThumbLow = getResources().getDrawable(R.drawable.shape_seekbarpressure_thumb);
        mThumbHigh = getResources().getDrawable(R.drawable.shape_seekbarpressure_thumb);
        ...
        mTextViewMarginTop = mThumbMarginTop + mThumbWidth / 2 + 12;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        defaultScreenHigh = progressHigh;
        defaultScreenLow = progressLow;
        String low = (int) progressLow + "";
        String high = (int) progressHigh + "";
        canvas.drawText(low, (int) mOffsetLow, mTextViewMarginTop, text_Paint);
        canvas.drawText(high, (int) mOffsetHigh, mTextViewMarginTop, text_Paint);
    ...
    public int getMaxProgress(){
        return (int) defaultScreenHigh;
    }

    public int getMinProgress(){
        return (int) defaultScreenLow;
    }
