...
public class WheelView<T> extends View implements Runnable {
    ...
    private void initAttrsAndDefault(Context context, AttributeSet attrs) {
        ...
        mTextColor = DEFAULT_NORMAL_TEXT_COLOR;
        mSelectedItemTextColor = DEFAULT_SELECTED_TEXT_COLOR;
        mLineSpacing = DEFAULT_LINE_SPACING;
        isIntegerNeedFormat = false;
        ...
        mDividerColor = DEFAULT_SELECTED_TEXT_COLOR;
